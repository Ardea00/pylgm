"""Fit a Gaussian region panel with a declared, empirical-Bayes-estimated precision."""
...
def main() -> None:
    ...
    print(f"empirical_bayes_converged: {result.diagnostics['empirical_bayes_converged']}")
